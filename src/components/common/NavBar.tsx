      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-4">
          <div className="hidden md:flex items-center gap-6">
            <a href="/bookings" className="nav-text flex flex-col items-center text-sm text-white hover:text-yellow-400 transition-all duration-300 hover:scale-105">
              <svg className="h-5 w-5 mb-1" fill="none" stroke="#fff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <rect x="3" y="4" width="18" height="18" rx="2" ry="2" strokeWidth="2" />
                <line x1="16" y1="2" x2="16" y2="6" strokeWidth="2" />
                <line x1="8" y1="2" x2="8" y2="6" strokeWidth="2" />
                <line x1="3" y1="10" x2="21" y2="10" strokeWidth="2" />
              </svg>
              <span className="text-xs tracking-wide text-white">BOOKINGS</span>
            </a>
            <a href="/login" className="nav-text flex flex-col items-center text-sm text-white hover:text-yellow-400 transition-all duration-300 hover:scale-105">
              <svg className="h-5 w-5 mb-1" fill="none" stroke="#fff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <circle cx="12" cy="8" r="5" strokeWidth="2" />
                <path d="M3 21v-2a7 7 0014 0v2" strokeWidth="2" />
              </svg>
              <span className="text-xs tracking-wide text-white">LOGIN</span>
            </a>
          </div>
        </div>
      </div>
